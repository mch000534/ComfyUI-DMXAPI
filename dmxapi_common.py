...
# ==================== 選項清單 ====================
# 各家上游的解析度字彙不同（MiniMax 用 768P/2K，Seedance 用 720p/4k），
...
#
# 兩個 MiniMax 系列接受的檔位不同，混用會被上游以 400 擋下：
#   H3 送 512P 會回 'resolution must be "768P" or "2K"'（實測確認）
# 因此換算時務必傳入該系列自己的檔位表，不要合成聯集。
